...
CREATE UNIQUE INDEX `ordemCategoria_UNIQUE` ON `projetoSAE`.`SAE_CategoriasItens` (`ordemCategoriaItens` ASC) VISIBLE;

CREATE UNIQUE INDEX `codCategoriasItensUUId_UNIQUE` ON `projetoSAE`.`SAE_CategoriasItens` (`codCategoriasItensUUId` ASC) VISIBLE;
